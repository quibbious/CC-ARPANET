-- a quick and easy way to delete CC:ARPANET from your system

shell.run("delete receiver.lua") -- downloads reciever.lua
shell.run("delete startup.lua") -- downloads startup.lua
